...
with_node \
  ...
  --target "/Users/alejandrochacon/Documents/Git/driftrBase/ios/Pods/Target Support Files/Pods-DriftrBase/ExpoModulesProvider.swift" \
  --entitlement "/Users/alejandrochacon/Documents/Git/driftrBase/ios/DriftrBase/DriftrBase.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linking" "expo-location" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
